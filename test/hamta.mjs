...
const kalla = [
  ...
  block(/function vagnFragaFor\(f\)\{[\s\S]*?\n\}/, "vagnsfrågan"),
  block(/function svenskaRoster\(\)\{[\s\S]*?\nfunction valjRost\(roster, vill, apple\)\{[\s\S]*?\n\}/, "rösten"),
